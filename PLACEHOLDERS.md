...
<code lang="js">
{0} - Return bot ID<br>
{1} - It's bot? Return true or false<br>
{2} - It's bot? Return Yes or No<br>
{3} - Return bot username<br>
{4} - Return bot discriminator<br>
...
{13} - Return bot actual version<br>
{14} - Return bot author<br>
{15} - Return GitHub URL repository<br>
{16} - Return guilds size<br>
...
{7} - Return member avatar image<br>
{8} - Return size members in guild<br>
{9} - Return size channels in guild<br>
{10} - Return size roles in guild<br>
{11} - Return guild ID<br>
{12} - Return guild name<br>
{13} - Return members size<br>
{14} - Return size emoji in guild<br>
{15} - Return guild owner ID<br>
{16} - Return guild owner username<br>
{17} - Return guild owner discriminator<br>
{18} - Return guild owner avatar image<br>
...
{1} - Return member ID<br>
{2} - Member bot? Return true or false<br>
{3} - Member bot? Return yes pot No<br>
{4} - Return member username<br>
{5} - Return member discriminator<br>
{6} - Return member information<br>
