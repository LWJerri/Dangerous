...
bot.on("ready", async () => {
  if (setting.botOn.enable) {
    if (setting.botOn.WelcomeMessage.enable) {
      ...
      let ConsoleMessage = setting.botOn.WelcomeMessage.ConsoleMSG.replace("{0}", bot.user.id)
    ...
    if (setting.botOn.botActivity.enable) {
      if ((setting.botOn.botActivity.botType.toUpperCase() === "STREAMING") & !setting.botOn.botActivity.botURL)
        return console.error(lang.NoStreamURL);
      ...
      bot.user.setPresence({
        activity: {
          name: BotPresenceMessage,
          url: setting.botOn.botActivity.botURL,
          type: setting.botOn.botActivity.botType.toUpperCase(),
        },
        status: setting.botOn.botActivity.botStatus,
      });
    }
    ...
    if (setting.userJoin.SendMessage.enable) {
      if (setting.userJoin.SendMessage.type.toUpperCase() === "MESSAGE") {
        ...
        if (setting.userJoin.SendMessage.deleteMessage) {
          ...
          member.send(UserWelcomeMessage).then((msg) =>
            msg.delete({
              timeout: parseInt(setting.userJoin.SendMessage.timeDelete),
            }),
          );
        } else {
        ...
        const EmbedTitle = setting.userJoin.SendMessage.EMBED.Title.replace("{0}", bot.user.username)
          .replace("{1}", member.user.id)
          .replace("{2}", member.user.bot)
          .replace("{3}", member.user.bot ? lang.Yes : lang.No)
          .replace("{4}", member.user.username)
        ...
        const EmbedURL = setting.userJoin.SendMessage.EMBED.URL.replace("{0}", member.user.displayAvatarURL({ size: 4096, dynamic: true }))
        ...
        const AuthorURL = setting.userJoin.SendMessage.EMBED.Author.URL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const EmbedDescription = setting.userJoin.SendMessage.EMBED.Description.replace("{0}", bot.user.username)
          .replace("{1}", member.user.id)
          .replace("{2}", member.user.bot)
          .replace("{3}", member.user.bot ? lang.Yes : lang.No)
          .replace("{4}", member.user.username)
        ...
        const ImageURLSmall = setting.userJoin.SendMessage.EMBED.ImageURLSmall.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const ImageURLBig = setting.userJoin.SendMessage.EMBED.ImageURLBig.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const FooterImageURL = setting.userJoin.SendMessage.EMBED.Footer.ImageURL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        if (setting.userJoin.SendMessage.deleteMessage) {
          ...
          member.send(embedWelcome).then((msg) =>
            msg.delete({
              timeout: parseInt(setting.userJoin.SendMessage.timeDelete),
            }),
          );
    ...
    if (setting.userJoin.ServerMessage.enable) {
      ...
      if (setting.userJoin.ServerMessage.type.toUpperCase() === "MESSAGE") {
        ...
        if (setting.userJoin.ServerMessage.deleteMessage) {
          ...
          bot.channels.cache
            .get(setting.userJoin.ServerMessage.channelID)
            .send(UserWelcomeMessage)
            .then((msg) =>
              msg.delete({
                timeout: parseInt(setting.userJoin.ServerMessage.timeDelete),
              }),
            );
        } else {
        ...
        const EmbedTitle = setting.userJoin.ServerMessage.EMBED.Title.replace("{0}", bot.user.username)
          .replace("{1}", member.user.id)
          .replace("{2}", member.user.bot)
          .replace("{3}", member.user.bot ? lang.Yes : lang.No)
          .replace("{4}", member.user.username)
        ...
        const EmbedURL = setting.userJoin.ServerMessage.EMBED.URL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const AuthorURL = setting.userJoin.ServerMessage.EMBED.Author.URL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const EmbedDescription = setting.userJoin.ServerMessage.EMBED.Description.replace("{0}", bot.user.username)
          .replace("{1}", member.user.id)
          .replace("{2}", member.user.bot)
          .replace("{3}", member.user.bot ? lang.Yes : lang.No)
          .replace("{4}", member.user.username)
        ...
        const ImageURLSmall = setting.userJoin.ServerMessage.EMBED.ImageURLSmall.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const ImageURLBig = setting.userJoin.ServerMessage.EMBED.ImageURLBig.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const FooterImageURL = setting.userJoin.ServerMessage.EMBED.Footer.ImageURL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
    ...
    if (setting.userLeave.ServerMessage.enable) {
      ...
      if (setting.userLeave.ServerMessage.type.toUpperCase() === "MESSAGE") {
        ...
        if (setting.userLeave.ServerMessage.deleteMessage) {
          ...
          bot.channels.cache
            .get(setting.userLeave.ServerMessage.channelID)
            .send(UserWelcomeMessage)
            .then((msg) =>
              msg.delete({
                timeout: parseInt(setting.userLeave.ServerMessage.timeDelete),
              }),
            );
        } else {
        ...
        const EmbedTitle = setting.userLeave.ServerMessage.EMBED.Title.replace("{0}", bot.user.username)
          .replace("{1}", member.user.id)
          .replace("{2}", member.user.bot)
          .replace("{3}", member.user.bot ? lang.Yes : lang.No)
          .replace("{4}", member.user.username)
        ...
        const EmbedURL = setting.userLeave.ServerMessage.EMBED.URL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const AuthorURL = setting.userLeave.ServerMessage.EMBED.Author.URL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const EmbedDescription = setting.userLeave.ServerMessage.EMBED.Description.replace("{0}", bot.user.username)
          .replace("{1}", member.user.id)
          .replace("{2}", member.user.bot)
          .replace("{3}", member.user.bot ? lang.Yes : lang.No)
          .replace("{4}", member.user.username)
        ...
        const ImageURLSmall = setting.userLeave.ServerMessage.EMBED.ImageURLSmall.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const ImageURLBig = setting.userLeave.ServerMessage.EMBED.ImageURLBig.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
        ...
        const FooterImageURL = setting.userLeave.ServerMessage.EMBED.Footer.ImageURL.replace(
          "{0}",
          member.user.displayAvatarURL({
            size: 4096,
            dynamic: true,
